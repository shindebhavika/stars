...
<div className="w-3/4 m-auto ">
      ...
      {!data?"<h1>No resident ON this planet</h1>":  <div  className="bg-white card-con h-[500px] text-black rounded-xl overflow-hidden shadow-md">
...
<div className="flex flex-col justify-center items-center gap-3 p-4">
  ...
  <p className="text-xl font-semibold"> Birth Year :{data.birth_year}</p>
</div>
</div>} 
